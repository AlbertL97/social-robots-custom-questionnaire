# Social-Robots Custom Questionnaire (full item list)

This repository contains the **entire survey instrument** used in our national Polish study on public attitudes toward social robots.  
It combines two validated scales (**NARS-PL**, **BHNU**) with 25 custom blocks covering contact, acceptance, emotional reactions, and perceived definitions of robots.
...
| | |
|---|---|
| **Mode** | CAWI (online) via Ariadna National Research Panel |
| **Fieldwork** | 26 – 30 October 2023 |
| **Sample** | N = 1 052 Polish adults (representative by gender, age, residence size) |
| **Avg. time** | ≈ 15 min |

---

## 2  Standardised scales

### 2.1 NARS-PL  
Polish adaptation of the **Negative Attitudes Toward Robots Scale**  
*12 items · two subscales*  
...
### 2.2 BHNU  
**Beliefs in Human Nature Uniqueness**  
*6 items measuring moral, emotional & ontological uniqueness*  

Same 5-point Likert rating as above.

> **Indexing:** Item scores are summed to create continuous NATIR, NARHT and BHNU indices (higher = stronger negative attitude or stronger uniqueness belief).

---

## 3  Custom questionnaire items  
*(exact Polish-English wording, no edits)*  
...
/any number of options/  [rotation]  
- senses like a human  
...
Clone, cite, and reuse responsibly.
